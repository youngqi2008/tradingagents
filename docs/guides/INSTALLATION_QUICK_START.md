...
> 5分钟快速上手 Ares 智能研报 v1.0.0-preview
...
- 关注公众号 "Ares 智能研报" 获取网盘链接

操作手册：

https://mp.weixin.qq.com/s/uAk4RevdJHMuMvlqpdGUEw
Ares 智能研报 v1.0.0-preview绿色版（目前只支持windows）简单使用手册
https://mp.weixin.qq.com/s/o5QdNuh2-iKkIHzJXCj7vQ
Ares 智能研报 v1.0.0-preview绿色版绿色版端口配置说明
---
...
- **GitHub Issues**: [提交问题](https://github.com/hsliuping/Ares 智能研报/issues)
- **微信公众号**: Ares 智能研报
- **QQ 群**: 关注公众号获取群号
