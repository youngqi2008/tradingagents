...
- **GitHub Releases**: [https://github.com/hsliuping/Ares 智能研报/releases](https://github.com/hsliuping/Ares 智能研报/releases)
- **百度网盘**: 关注公众号 "Ares 智能研报" 获取下载链接
- **阿里云盘**: 关注公众号 "Ares 智能研报" 获取下载链接
...
2. **下载 docker-compose.yml**：
   ```bash
   # 从 GitHub 下载
   curl -O https://raw.githubusercontent.com/hsliuping/Ares 智能研报/main/docker-compose.yml
...
3. **创建 .env 文件**：
   ```bash
   # 复制示例配置
   curl -O https://raw.githubusercontent.com/hsliuping/Ares 智能研报/main/.env.example
   mv .env.example .env
...
1. **克隆代码**：
   ```bash
   git clone https://github.com/hsliuping/Ares 智能研报.git
   cd Ares 智能研报
   ```
...
1. **查看文档**: [docs/](../)
2. **GitHub Issues**: [https://github.com/hsliuping/Ares 智能研报/issues](https://github.com/hsliuping/Ares 智能研报/issues)
3. **微信公众号**: Ares 智能研报
4. **QQ 群**: 关注公众号获取群号
