...
Ares 智能研报 v0.1.7 引入了完整的Docker容器化部署方案，让您可以通过一条命令启动完整的股票分析环境。本指南将详细介绍如何使用Docker部署和管理Ares 智能研报。
...
**重要说明**: Ares 智能研报目前不提供预构建的Docker镜像，需要在本地构建。
...
- 💬 [GitHub Discussions](https://github.com/hsliuping/Ares 智能研报/discussions)
