...
Ares 智能研报 支持多种货币单位的模型定价，不同的 LLM 厂家使用不同的货币进行计费。

Ares 智能研报 supports multiple currency units for model pricing. Different LLM providers use different currencies for billing.
...
- 🌐 GitHub: https://github.com/hsliuping/Ares 智能研报
