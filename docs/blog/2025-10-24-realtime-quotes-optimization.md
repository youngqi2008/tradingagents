...
docker build --platform linux/amd64 -t Ares 智能研报:amd64 .
docker tag Ares 智能研报:amd64 your-registry/Ares 智能研报:amd64
docker push your-registry/Ares 智能研报:amd64

# ARM64 架构（Apple Silicon/ARM服务器）
docker build --platform linux/arm64 -t Ares 智能研报:arm64 .
docker tag Ares 智能研报:arm64 your-registry/Ares 智能研报:arm64
docker push your-registry/Ares 智能研报:arm64
```
...
```bash
# AMD64 用户
docker pull your-registry/Ares 智能研报:amd64

# ARM64 用户
docker pull your-registry/Ares 智能研报:arm64
```
...
如有问题或建议，欢迎在 [GitHub Issues](https://github.com/hsliuping/Ares 智能研报/issues) 中反馈。
