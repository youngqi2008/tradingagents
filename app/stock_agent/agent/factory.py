...
def get_tool_registry():
    ...
    from app.stock_agent.agent.tools.registry import ToolRegistry
    from app.stock_agent.agent.tools.data_tools import ALL_DATA_TOOLS
    from app.stock_agent.agent.tools.analysis_tools import ALL_ANALYSIS_TOOLS
    from app.stock_agent.agent.tools.search_tools import ALL_SEARCH_TOOLS
    from app.stock_agent.agent.tools.market_tools import ALL_MARKET_TOOLS
...
def get_skill_manager(config=None):
    ...
    from app.stock_agent.agent.skills.base import SkillManager
...
def build_agent_executor(config=None, skills: Optional[List[str]] = None):
    ...
    from app.stock_agent.agent.executor import AgentExecutor
    from app.stock_agent.agent.llm_adapter import LLMToolAdapter
