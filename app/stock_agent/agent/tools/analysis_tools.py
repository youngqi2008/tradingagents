...
from app.stock_agent.agent.tools.registry import ToolParameter, ToolDefinition
...
def _fetch_trend_data(stock_code: str):
    ...
    import pandas as pd
    from app.stock_agent.data_provider.base import canonical_stock_code, DataFetchError
    from app.stock_agent.data_provider import DataFetcherManager
    from app.stock_agent.dsa_storage import get_db
...
def _handle_analyze_trend(stock_code: str) -> dict:
    ...
    from app.stock_agent.stock_analyzer import StockTrendAnalyzer
