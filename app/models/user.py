...
class User(BaseModel):
    ...
    # 小程序与计费扩展
    user_type: str = Field(default="admin", description="admin=运营后台用户, mp_user=小程序用户")
    role: str = Field(default="normal", description="小程序角色：normal=普通, risk_officer=风控专员")
    openid: Optional[str] = Field(default=None, description="微信 openid")
    unionid: Optional[str] = Field(default=None, description="微信 unionid")
    nickname: Optional[str] = Field(default=None, description="昵称")
    avatar_url: Optional[str] = Field(default=None, description="头像")
    phone: Optional[str] = Field(default=None, description="手机号")
    membership_level_id: Optional[str] = Field(default=None, description="会员等级 ID")
    balance: Decimal = Field(default=Decimal("0"), description="账户余额（元）")
