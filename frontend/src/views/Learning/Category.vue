  ...
  'analysis-principles': [
    {
      ...
      title: '多智能体系统详解',
      description: '深入理解Ares 智能研报的多智能体协作机制',
      readTime: '15分钟',
      views: 1654,
      difficulty: 'warning',
      difficultyText: '进阶'
  ...
  'resources': [
    {
      ...
      title: '平台技术架构说明',
      description: '了解本平台所采用的多智能体架构与核心特性',
      readTime: '15分钟',
      views: 1432,
      difficulty: 'warning',
      difficultyText: '进阶'
  ...
  'tutorials': [
    {
      id: 'getting-started',
      title: '快速入门教程',
      description: '从零开始学习如何使用Ares 智能研报进行股票分析',
      readTime: '10分钟',
      views: 3456,
      difficulty: 'success',
      difficultyText: '入门'
    },
    {
      ...
      title: '使用指南（试用版）',
      description: 'Ares 智能研报 使用指南与试用说明',
      readTime: '15分钟',
      views: 1288,
      difficulty: 'success',
      difficultyText: '入门'
