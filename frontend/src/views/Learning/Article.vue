...
const registry: Record<string, ArticleInfo> = {
  ...
  'tradingagents-intro': { title: '平台技术架构说明', loader: () => import('../../../../docs/learning/06-resources/tradingagents-intro.md?raw'), category: '技术架构与论文', categoryType: 'primary', readTime: '15分钟' },
