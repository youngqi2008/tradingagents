    ...
    <div class="welcome-section">
      <div class="welcome-content">
        ...
        <p class="welcome-subtitle">
          企业级多智能体股票分析平台，从多维度为您提供专业市场分析与投资决策支持
        </p>
      </div>
          ...
          <div v-else class="favorites-list">
            ...
            >
              ...
              <div class="stock-price">
                ...
                >
                  {{ stock.change_percent != null && stock.change_percent !== undefined ? (stock.change_percent > 0 ? '+' : '') + (Number.isFinite(Number(stock.change_percent)) ? Number(stock.change_percent).toFixed(2) : '-') + '%' : '-' }}
                </div>
              </div>
            </div>
          </div>
