                    ...
                    <div class="decision-main">
                      ...
                      <div class="decision-metrics">
                        ...
                        <div class="metric-item">
                          ...
                          <span class="value">{{ analysisResults.decision.confidence != null ? (Number(analysisResults.decision.confidence) * 100).toFixed(1) : '-' }}%</span>
                        ...
                        <div class="metric-item">
                          ...
                          <span class="value">{{ analysisResults.decision.risk_score != null ? (Number(analysisResults.decision.risk_score) * 100).toFixed(1) : '-' }}%</span>
      ...
      setup() {
        ...
        return () => h('div', { style: 'line-height: 2;' }, [
          ...
          recommendation.action === 'buy' ? h('p', { style: 'color: #909399; font-size: 12px; margin-top: 12px;' },
            `可用资金：${account.cash != null && Number.isFinite(Number(account.cash)) ? Number(account.cash).toFixed(2) : account.cash || '0'}元，最大可买：${maxQuantity}股`
          ) : null,
