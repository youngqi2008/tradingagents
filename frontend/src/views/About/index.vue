  ...
  <div class="about">
      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <p class="hero-description">
            基于先进的AI技术与多智能体协作架构，为机构与个人投资者提供专业、准确、及时的股票分析服务。
            从基本面、技术面、新闻与舆情等多维度对标的进行全方位分析，助力更明智的投资决策。
          </p>
          <div class="hero-acknowledgment">
            <el-icon><Star /></el-icon>
            <span>基于成熟的多智能体分析架构，为企业与个人投资者提供专业级分析能力</span>
          </div>
    ...
    <div class="footer-section">
      <div class="footer-content">
        ...
        <p>本产品采用专有许可证，商业使用需获得授权。个人学习与研究用途请参阅具体条款。</p>
      </div>
    </div>
  </div>
</template>
