<template>
  ...
  >
    ...
    <el-sub-menu index="/ops">
      ...
      <el-menu-item index="/ops/dashboard">运营看板</el-menu-item>
      <el-menu-item index="/ops/users">用户管理</el-menu-item>
      <el-menu-item index="/ops/roles">角色管理</el-menu-item>
      <el-menu-item index="/ops/tasks">研报任务</el-menu-item>
      <el-menu-item index="/ops/chat-sessions">问股会话</el-menu-item>
      <el-menu-item index="/ops/membership">会员等级</el-menu-item>
      <el-menu-item index="/ops/benefits">客户权益</el-menu-item>
      <el-menu-item index="/ops/favorites">自选股订阅</el-menu-item>
      <el-menu-item index="/ops/billing">计费订单</el-menu-item>
      <el-menu-item index="/ops/notifications">站内通知</el-menu-item>
    </el-sub-menu>
