...

  {
    ...
    children: [
      ...
      },
      {
        path: 'users',
        name: 'MpUsers',
        component: () => import('@/views/Ops/MpUsers.vue'),
        meta: { title: '用户管理', requiresAuth: true },
      },
      {
        path: 'users/:id',
        name: 'MpUserDetail',
        component: () => import('@/views/Ops/MpUserDetail.vue'),
      ...
      {
        path: 'tasks',
        name: 'MpAnalysisTasks',
        component: () => import('@/views/Ops/MpAnalysisTasks.vue'),
        meta: { title: '研报任务', requiresAuth: true },
      },
      {
        path: 'chat-sessions',
        name: 'MpChatSessions',
        component: () => import('@/views/Ops/MpChatSessions.vue'),
        meta: { title: '问股会话', requiresAuth: true },
      },
      {
        path: 'membership',
        name: 'MembershipLevels',
        component: () => import('@/views/Ops/MembershipLevels.vue'),
        meta: { title: '会员等级', requiresAuth: true },
      },
      {
        path: 'benefits',
        name: 'BenefitCampaigns',
        component: () => import('@/views/Ops/BenefitCampaigns.vue'),
        meta: { title: '客户权益', requiresAuth: true },
      },
      {
        path: 'favorites',
        name: 'OpsFavoritesManage',
        component: () => import('@/views/Ops/FavoritesManage.vue'),
        meta: { title: '自选股订阅', requiresAuth: true },
      },
      {
        path: 'billing',
        name: 'BillingRecords',
        component: () => import('@/views/Ops/BillingRecords.vue'),
        meta: { title: '计费订单', requiresAuth: true },
      },
      {
        path: 'notifications',
        name: 'MpNotifications',
        component: () => import('@/views/Ops/MpNotifications.vue'),
...
router.beforeEach(async (to, from, next) => {
  ...
  if (title) {
    document.title = `${title} - Ares 智能研报`
  }
