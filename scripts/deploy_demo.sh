...
GITHUB_REPO="https://github.com/your-org/Ares 智能研报"
GITHUB_RAW="https://raw.githubusercontent.com/your-org/Ares 智能研报/main"
...
verify_deployment() {
    ...
    # 测试后端 API
    print_info "测试后端 API..."
    if curl -s http://localhost:8800/api/health | grep -q "healthy"; then
...
show_info() {
    ...
    echo ""
    echo -e "${BLUE}访问信息:${NC}"
    echo -e "  前端地址: ${GREEN}http://$SERVER_IP:3300${NC}"
    echo -e "  后端地址: ${GREEN}http://$SERVER_IP:8800${NC}"
    echo ""
    echo -e "${BLUE}登录信息:${NC}"
    ...
    echo ""
    echo -e "${BLUE}文档:${NC}"
    echo -e "  完整文档: ${GREEN}https://github.com/your-org/Ares 智能研报/blob/main/docs/deploy_demo_system.md${NC}"
    echo ""
}
