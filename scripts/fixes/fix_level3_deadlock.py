...
def apply_fundamentals_analyst_fix():
    ...
    fundamentals_file = "d:\\code\\Ares 智能研报\\tradingagents\\agents\\analysts\\fundamentals_analyst.py"
...
def apply_conditional_logic_fix():
    ...
    conditional_file = "d:\\code\\Ares 智能研报\\tradingagents\\graph\\conditional_logic.py"
...
'''
    ...
    with open("d:\\code\\Ares 智能研报\\test_level3_fix.py", 'w', encoding='utf-8') as f:
