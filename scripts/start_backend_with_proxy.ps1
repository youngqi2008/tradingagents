# Ares 智能研报 Backend Startup Script with Proxy Configuration
# 启动后端服务，并配置选择性代理

Write-Host "🚀 启动 Ares 智能研报 后端服务..." -ForegroundColor Green
Write-Host ""
...
Write-Host "   访问地址: http://localhost:8800" -ForegroundColor Cyan
Write-Host "   API 文档: http://localhost:8800/docs" -ForegroundColor Cyan
Write-Host ""
